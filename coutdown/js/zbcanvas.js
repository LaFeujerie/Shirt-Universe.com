        ...
        zbCanvas: function(userCanvasSettings) {
            ...
            this.circle = {
                ...
                draw: function(userCircleSettings) {
                    ...
                    ctx.canvas.height = ctx.canvas.width = parent._circleSettings.radius;
                    ...
                    var drawStep = function(from, to) {
                        ...
                        if (parent._circleSettings.bgColor != "none") {
                            ...
                            ctx.arc(
                                parent._circleSettings.radius / 2, 
                                parent._circleSettings.radius / 2, 
                                parent._circleSettings.radius / 2 - parent._circleSettings.bgWidth / 2 - parent._circleSettings.bgShadowBlur,
                                parent._deg(0), 
                                parent._deg(360)
                            );
                            ctx.stroke();
                        ...
                        ctx.arc(
                            parent._circleSettings.radius / 2, 
                            parent._circleSettings.radius / 2, 
                            parent._circleSettings.radius / 2 - parent._circleSettings.lineWidth / 2 - parent._circleSettings.shadowBlur,
                            parent._deg(from), 
                            parent._deg(to)
                        );
